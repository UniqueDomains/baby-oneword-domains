# Available .BABY One-Word Domains (8,619)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C619%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C619%20domains-6f42c1">
  <img alt="formats" src="https://img.shields.io/badge/formats-CSV%20%7C%20JSON-f59e0b">
  <img alt="license" src="https://img.shields.io/badge/license-see%20LICENSE-6b7280">
</p>

Daily-updated dataset of available and resale .baby one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 8,619 rows · **Live catalog:** 8,619 domains
...
- `baby.csv` — public CSV extract (8,619 rows)
- `baby.json` — public JSON extract (8,619 rows)
...
| whole.baby      | resell    | $29.99    | $94.99        | 104            | 21     | 5      | Dynadot LLC                                         |
| live.baby       | premium   | $625      | $94.99        | 108            | 56     | 4      | name.com                                            |
...
| one.baby        | premium   | $3,125    | $94.99        | 132            | 50     | 3      | name.com                                            |
...
| agile.baby      | available | $29.99    | $94.99        | 92             | 41     | 5      | name.com                                            |
...
| ----------------------- | ------------------------------------------------ |
| 8,619-row public sample | 8,619 live domains                               |
...
> Unique Domains. *Available .BABY One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
