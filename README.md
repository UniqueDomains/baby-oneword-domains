# Available .BABY One-Word Domains (29,102)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-29%2C102%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **29,102 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 29,102 domains · **Median ask:** $15.53 · **High-demand under $2,500:** 31
...
| --------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------- |
| ago.baby  | available | $17.99    | $54.99        | low            | low    | 3      | namesilo        |
...
| door.baby | resell    | —         | —             | medium         | low    | 4      | Dynadot Inc     |
...
| bond.baby | premium   | $242      | $53.92        | high           | low    | 4      | namesilo        |
| jot.baby  | available | $29.99    | —             | high           | low    | 3      | name.com        |
| step.baby | resell    | —         | —             | high           | low    | 4      | Spaceship, Inc. |
| hang.baby | premium   | $625      | —             | high           | low    | 4      | name.com        |
| lag.baby  | available | $17.99    | $54.99        | medium         | low    | 3      | namesilo        |
| well.baby | resell    | —         | —             | high           | low    | 4      | Dynadot Inc     |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 29,102 live domains                        |
...
This list covers one-word domain names on the .baby extension, spanning everyday words, playful names, and niche terms. Of the 11,465 names tracked, 10,871 are available now, with smaller pools of premium (238) and resell (356) listings. The vast majority price under $500, making this a low-cost entry point for testing a brandable .baby name.

- 10,871 of 11,465 .baby names are available now
- Median ask is about $41; most list under $500
- Only 11 names sit in the top 15% demand tier
- 1,892 names carry higher renewal costs to check first
...
> Unique Domains. *Available .BABY One-Word Domains*. Version 2026-09-24. Public GitHub extract for the exact Unique Domains search represented by this repository.
