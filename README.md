...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C615%20rows-8250df">
...
> **Important:** this repository is a **public 8,615-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **8,619 domains** on the canonical page below.

**Public extract:** 8,615 rows · **Live catalog:** 8,619 domains
...
- `baby.csv` — public CSV extract (8,615 rows)
- `baby.json` — public JSON extract (8,615 rows)
...
| punk.baby       | resell    | —         | —             | 102            | 98     | 4      | CHENGDU WEST DIMENSION DIGITAL TECHNOLOGY CO., LTD. |
...
| ----------------------- | ------------------------------------------------ |
| 8,615-row public sample | 8,619 live domains                               |
